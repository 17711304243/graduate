    ...
    document.forms[0].submit();
	 ...
	 $(function () {
		...
		$('#exportExcel').click(function(){
			var file_name = window.prompt("请指定输出文件名称(.xls)", /* "C:/register.xls" */"/Users/thekey/Downloads/register.xls");
			$.ajax({
				type : "POST",
...
<table class="table table-bordered table-hover definewidth m10" >
  ...
  <table class="table table-bordered table-hover definewidth m10" >
  	...
  	<div class="inline pull-right page">
		 ...
		 <div><button type="button" class="btn btn-success" id="newNav">添加患者信息</button>&nbsp;&nbsp;&nbsp;
