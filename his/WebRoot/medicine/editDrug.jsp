...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        <td width="10%" class="tableleft">中药名称</td>
        <td><input type="text" name="drugName" value="${drug.drugName}"/></td>
    </tr>
    <tr id="type">
        <td width="10%" class="tableleft">中药类型</td>
        <td><input type="radio" name="drugType" value="1" checked/>解表药&nbsp;&nbsp;&nbsp;<input type="radio" name="drugType" value="2"/>清热药&nbsp;&nbsp;&nbsp;<input type="radio" name="drugType" value="3"/>泻下药</td>
    </tr>
    <tr>
