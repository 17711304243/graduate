...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='2' />中医专家管理</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='3' />中药管理</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='4' />住院办理</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='5' />费用管理</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='6' />医生配药</label></ul> 
       <!--  <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='7' />辩证治疗</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='8' />病例管理</label></ul>  -->
 <!--        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='8' />月营业额统计</label></ul> 
        ...
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='11' />权限管理</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='12' />资源管理</label></ul> 
        <!-- <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='13' />辩证思想</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='14' />中药功效</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='15' />疾病查询</label></ul> 
        <ul><label class='checkbox inline'><input type='checkbox' name='group[]' value='16' />案例查询</label></ul>  -->
		</td>
    </tr>
    <tr>
