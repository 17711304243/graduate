...
public class MonitorController {
	...
	public  void saveTest(HttpServletRequest request,HttpServletResponse response){
		...
		//判断上传数据是否为空
		if(highpress1.trim().equals("")||lowpress1.trim().equals("")||temperature1.trim().equals("")
						||pulse1.trim().equals("")||doctorname.trim().equals("")) {
			try {
		...
		//判断是否需要报警
		if(highpress>0||lowpress>0||temperature>0||pulse>0)
		{
			warning=1;
		}
		//根据医生名字判断医生id
