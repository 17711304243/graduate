	...
	{	
		...
		if(loginType.equals("normal"))//病人
		{
			...
			if(count==1)
			{
				...
				try {
					//JOptionPane.showMessageDialog(null, "用户名或密码错误 ", "用户登录 ", JOptionPane.ERROR_MESSAGE);
					response.sendRedirect("../page/main/login.jsp");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
		...
		if(loginType.equals("dynamic"))//医生
		{
			...
			if(count==1)
			{
				...
				try {
					//JOptionPane.showMessageDialog(null, "用户名或密码错误 ", "医生登录 ", JOptionPane.ERROR_MESSAGE);
					response.sendRedirect("../page/main/login.jsp");
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
