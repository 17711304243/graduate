...
<body>
		...
		<div id="container">
            ...
            <a style="font:'Times New Roman', Times, serif; font-size:large; color:#0066FF; margin-bottom:10px;">疾病咨询</a>
            <a style="float:right;font:'Times New Roman', Times, serif; font-size:large; color:#0066FF;margin-bottom:10px;" onClick="show()" href="#">发布问题</a>
...
<div class="popup-con" id="popup-con">
        ...
        <div class="abc">
                <form action="<%= basePath%>title/addcontext.do" method="post">
                   ...
                   <div class="text">
                      <label class="user label">咨询问题</label>
                   ...
                   <div class="text">
                      <label class="user label">咨询医生</label>
                     ...
                     <div class="text">
                      <label class="user label">病情描述</label>
                      <div class="text-input">
